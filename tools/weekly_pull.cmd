@echo off
rem ============================================================================
rem SwingEdge weekly pull — run by Windows Task Scheduler (task "SwingEdge Weekly Pull").
...
rem and commits + pushes. Logs to .secrets\weekly_pull.log (gitignored).
rem Requires: your sessionid in .secrets\screener_cookie.txt (else it exits cleanly).
rem Run manually any time:  tools\weekly_pull.cmd
rem ============================================================================
setlocal
cd /d "%~dp0.."
set "PATH=C:\Program Files\Git\cmd;%PATH%"
if not exist ".secrets" mkdir ".secrets"
set "LOG=.secrets\weekly_pull.log"
echo(>> "%LOG%"
echo ==================================================================== >> "%LOG%"
echo [%date% %time%] weekly pull start >> "%LOG%"
